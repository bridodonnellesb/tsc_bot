    ...
    const UnhelpfulFeedbackContent = () => {
        return (<>
            ...
            <Stack tokens={{childrenGap: 4}}>
                ...
                <Checkbox label="Citations are out of date" id={Feedback.OutOfDate} defaultChecked={negativeFeedbackList.includes(Feedback.OutOfDate)} onChange={updateFeedbackList}></Checkbox>
            ...
            <Stack className={styles.answerContainer} tabIndex={0}>
                ...
                <Stack horizontal className={styles.answerFooter}>
                    ...
                    <Stack.Item className={styles.answerDisclaimerContainer}>
                        <span className={styles.answerDisclaimer}>Results based on documents retrieved from SEM-O website on 09/10/2024. AI-generated content may be incorrect. </span>
                    </Stack.Item>
                </Stack>
                {chevronIsExpanded &&
